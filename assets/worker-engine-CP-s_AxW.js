...
`],{type:"application/javascript"})),{type:"module"});return e.postMessage({type:"wasmInit",wasmUrl:c,logger:n?F(n):void 0}),new h(e,n)}export{b as createPdfiumEngine};
//# sourceMappingURL=worker-engine-CP-s_AxW.js.map
